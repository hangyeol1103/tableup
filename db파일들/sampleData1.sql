...
INSERT INTO `foodcategory` (`fc_main`) 
	VALUES ('1.한식'),('2.일식'),('3.양식'),('4.중식'),('5.고기구이'),('6.생선/해산물'),('7.뷔페/무한리필'),
		   ('8.카페'),('9.주점/다이닝바'),('10.아시아'),('11.맥시코,남미'),('12.퓨전요리')
           ,("13. 패스트 푸드"),('14.기타');

INSERT INTO `detailfoodcategory` (`dfc_sub`,`dfc_fc_num`) 
	VALUES 
    -- 고기류 
    ("스테이크",3),("한우오마카세",5),("바베큐",3),("족발,보쌈",1),("곱창, 막창",5),("양고기",5),("소고기구이",5),("돼지고기구이",5),("돈까스",2),("닭고기",5),("오리",5),
	-- 생선, 해물 요리
    ("회,사시미",6),("초밥, 스시",2),("장어 요리",2),("참치회",6),("갑각류(게, 랍스터)",6),
    ("해물(탕/찜/볶음)",6),("조개류(굴, 조개구이)",6),("스시 오마카세",2),("가이세키오마카세",2),
    -- 주류
    ("와인",9),("전통주",9),("칵테일/위스키",9),("소주,맥주,호프",9),("주류",9),
    -- 카페 & 베이커리
    ("커피/차/음료",8),("빵,베이커리",8),("디저트",8),("케이크",8),
    -- 나머지 
    ("파인다이닝",3),("한정식",1),("중식 코스 요리",4),
    ("찌개,전골",1),("튀김",2),("파스타",3),("피자",13),("햄버거",13),
    ("비건",14),("샤브샤브",2),("라멘",2),("냉면",1),("국수",1),
    ("백반/가정식",1),("분식",1),("기타 오마카세",14),("팝업 스토어",14),("브런치",3),
    ("쌀국수/분짜",10),("종합",7);
